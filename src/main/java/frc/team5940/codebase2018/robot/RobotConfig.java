...
public interface RobotConfig {
	...
	public static final int INTAKE_CLAMP_BUTTON = LogitechJoystickControllerLayout.Buttons.BUTTON_3;

	public static final int INTAKE_UNCLAMP_BUTTON = LogitechJoystickControllerLayout.Buttons.BUTTON_4;

	public static final int INTAKE_CONTROL_FORWARD_AXIS = LogitechJoystickControllerLayout.Axis.JOYSTICK_Y;

	public static final int INTAKE_CONTROL_YAW_AXIS = LogitechJoystickControllerLayout.Axis.JOYSTICK_ROTATE;

	public static final int ELEVATOR_CONTROL_AXIS = LogitechJoystickControllerLayout.Axis.SLIDER;
	...
	// TODO
	public static final float NEW_ROBOT_LOW_GEAR_MAX_VELOCITY = 6f;

	// TODO
	public static final float NEW_ROBOT_HIGH_GEAR_MAX_VELOCITY = 12f;
	...
	public static final int SOLENOID_MODULE_NUMBER = 0;
